-- User Profiles Database Schema for NPGX Platform (Simplified - No RLS)
...
-- Note: RLS policies will be added later after tables are confirmed working
-- For now, tables are created without RLS for testing purposes 