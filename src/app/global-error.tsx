...
/**
 * Root-layout error boundary — catches crashes in the root layout itself
 * (where app/error.tsx cannot help). Must render its own <html>/<body>.
 */
      ...
      >
        <div style={{ maxWidth: 520 }}>
          ...
          <h1 style={{ fontSize: '2rem', fontWeight: 900, lineHeight: 1, marginBottom: 12 }}>
            bMovies crashed during layout.
          </h1>
          <p style={{ color: '#888', fontSize: '0.875rem', lineHeight: 1.6, marginBottom: 20 }}>
            Reload to recover. If this keeps happening please include the
            digest below so we can track it down.
          </p>
          {error.message && (
            <pre
              style={{
